...
protocol ServiceRepresentable {
    func sendRequestWithJSON(endpoint: String, method: HTTPMethod, parameters: [String:Any]?, header: String?, _ onCompletion: @escaping ( _ response: Any?, _ error: Error?) -> Void)
}
